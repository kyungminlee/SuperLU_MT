 ...
 */
    ...
    extern int pcgst01(int, int, SuperMatrix *, SuperMatrix *,
                         SuperMatrix *, int *, int *, float *);
    extern int pcgst02(trans_t, int, int, int, SuperMatrix *, complex *,
                         int, complex *, int, float *resid);
    extern int pcgst04(int, int, complex *, int,
                         complex *, int, float rcond, float *resid);
    extern int pcgst07(trans_t, int, int, SuperMatrix *, complex *, int,
