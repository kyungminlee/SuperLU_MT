 ...
 */
    ...
    extern int pzgst01(int, int, SuperMatrix *, SuperMatrix *,
                         SuperMatrix *, int *, int *, double *);
    extern int pzgst02(trans_t, int, int, int, SuperMatrix *, doublecomplex *,
                         int, doublecomplex *, int, double *resid);
    extern int pzgst04(int, int, doublecomplex *, int,
                         doublecomplex *, int, double rcond, double *resid);
    extern int pzgst07(trans_t, int, int, SuperMatrix *, doublecomplex *, int,
